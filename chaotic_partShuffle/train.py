# chaotic_partShuffle/train.py
import os, sys
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "_shared"))
from encrypt_ops import apply_xor_then_partshuffle
...
MODEL_OUT = "best_model_chaotic_partShuffle.pth"
...
if __name__ == "__main__":
    ...
    tr_ds = RSNADataset(DATA_DIR, label_map, transform=tfm, filter_ids=tr_ids,
                        preprocess_fn=apply_xor_then_partshuffle,
                        preprocess_kwargs={"key": CHAOTIC_KEY, "block": BLOCK_SIZE})
