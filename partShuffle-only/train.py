# partShuffle-only/train.py
import os, sys
sys.path.append(os.path.join(os.path.dirname(__file__), "..", "_shared"))
from encrypt_ops import apply_partshuffle_only
...
MODEL_OUT = "best_model_partShuffle.pth"
IMAGE_SIZE = 224
BLOCK_SIZE = 8  # 4 또는 8 권장
...
if __name__ == "__main__":
    ...
    tr_ds = RSNADataset(DATA_DIR, label_map, transform=tfm, filter_ids=tr_ids,
                        preprocess_fn=apply_partshuffle_only,
                        preprocess_kwargs={"block": BLOCK_SIZE})
